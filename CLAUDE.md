...
- `npm run refresh:videos` - Same feed refresh; add `-- --strict` for non-zero exit on failure (used by `.github/workflows/refresh-videos.yml`, which also opens a PR when the snapshot changes — see `docs/video-feed-refresh.md`)
...
- `--color-background: #F8F8F8` (off-white page background)
- `--color-foreground: #2E1D23` (brown)
- `--color-primary: #2C3930` (Tokyo Green)
- `--color-primary-hover: #3F4F44` (Light Green)
- `--color-accent: #B111D5` (Purple Light)
- `--color-accent-dark: #511B5D` (Purple Dark)
- `--color-sand: #ECDBBF` (warm light beige/hover text)
- `--color-beige: #A27B5D` (warm brown/focus rings)
- `--color-surface: #F8F8F8` (off-white cards/sections)
