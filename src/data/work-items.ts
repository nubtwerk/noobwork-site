...
export const workItems: WorkItem[] = [
  {
    ...
    role: "Creator",
    phase: "Current",
    desc: "The original platform and the one I'm rebuilding now with daily content. What started as one of Norway's biggest gaming channels grew to nearly 200,000 subscribers and became the foundation for everything that followed.",
